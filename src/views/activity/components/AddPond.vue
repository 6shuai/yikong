        ...
        <div class="add-pond-wrap">
            <el-scrollbar>
                ...
                >
                    ...
                    <el-divider content-position="left" v-if="pondParams.id">发奖条件</el-divider>
                    <el-form-item 
                        v-if="pondParams.id"
                        prop="condition">
                        <el-button
                            ...
                            size="small"
                            plain
                            @click="$refs.addCondition.showDialog({
                                    poolId: pondParams.id,
                                })"
                            >添加发奖条件</el-button
                        >

                        <div class="condition-warp" v-loading="conditionLoading">
                            <el-card v-for="(item, index) in conditionData" :key="item.id">
                                    ...
                                    >
                                        ...
                                        <div style="text-align: right; margin: 0">
                                            <el-button
                                                size="mini"
                                                type="text"
                                                @click="$refs['condition-' + index][0].doClose()"
                                                >取消</el-button
                                            >
                                            <el-button
                                                type="primary"
                                ...
                                >
                                    ...
                                    <div style="text-align: right; margin: 0">
                                        <el-button
                                            size="mini"
                                            type="text"
                                            @click="$refs['prize-' + item.id][0].doClose()"
                                            >取消</el-button
                                        >
                                        <el-button
                                            type="primary"
        ...
        handleSavePond() {
            this.$refs.addPondForm.validate((valid) => {
                if (valid) {
                    ...
                    this.pondParams.promotionId = this.$route.params.id;
