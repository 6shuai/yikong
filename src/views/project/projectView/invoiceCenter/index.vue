...
export default {
    ...
    methods: {
        ...
        handleShowInvoiceDetail(id = null){
            this.$router.push(`/invoiceApply?projectId=${this.$route.params.id}&invoiceId=${id}&clientId=${this.$store.state.project.projectDetail.client}`)
        },
        ...
        // 修改申请
        handleEdit(id){
            this.$router.push(`/invoiceApply?projectId=${this.$route.params.id}&invoiceId=${id}&clientId=${this.$store.state.project.projectDetail.client}&edit=1`)
        }   
    }
}
</script>
