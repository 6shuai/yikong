<template>
    <div class="create-contract-wrap">
        ...
        >
            ...
            <el-form-item label="付款截止日期:" prop="paymentDue">
                <el-date-picker
                    v-show="showEdit"
            ...
            <el-form-item label="提成体系:" prop="commissionSystem">
                <el-select 
                    class="w220"
                    v-show="showEdit"
            ...
            <el-form-item label="回款计划:">
                <ul class="return-money" v-show="showEdit">
                    ...
                    >
                        ...
                        <span class="right-icon">
                            <i 
                                v-if="contractParams.paymentSchedules.length-1 == index"
                                class="el-icon-plus" 
                                @click="contractParams.paymentSchedules.push({})"
                            ></i>
                            <i 
                ...
                <div class="return-money" v-show="!showEdit">
                    <el-table
                        v-if="contractParams.paymentSchedules && contractParams.paymentSchedules.length && contractParams.paymentSchedules[0].amount"
                        border
                        size="small"
                        :data="contractParams.paymentSchedules">
                        <el-table-column 
                            prop="amount" 
                            label="回款金额" 
                            min-width="100"
...
export default {
    ...
    methods: {
        ...
        // 获取合同详情
        getContractDetail(){
            let newData = this.$store.state.project.projectContractDetail
