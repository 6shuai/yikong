	...
	<el-card class="template-card content-details statistics-list">
		...
		<el-form label-width="80px" :inline="true">
			...
			<el-form-item label="时间范围">
                ...
                <el-radio-group v-model="params.viewByDay" @change="search">
                    <el-radio-button :label="1">每天</el-radio-button>
                    <el-radio-button :label="0">半小时</el-radio-button>
                </el-radio-group>
			</el-form-item>
		</el-form>
		...
		>
			...
			<el-table-column
				...
				min-width="80"
			></el-table-column>
			<el-table-column prop="playtime" label="人均时长" min-width="80">
			...
			this.$refs.statisticsDetail.showDialog(
				{
                    ...
                    viewByDay: this.params.viewByDay
				},
